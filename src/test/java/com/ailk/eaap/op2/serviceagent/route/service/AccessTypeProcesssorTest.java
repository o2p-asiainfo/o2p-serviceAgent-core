...
/**
 * The class <code>AccessTypeProcesssorTest</code> contains tests for the class <code>{@link AccessTypeProcesssor}</code>.
 *
 * @generatedBy CodePro at 15-11-12 下午8:06
 * @author wuwz
 * @version $Revision: 1.0 $
 */
public class AccessTypeProcesssorTest {
	/**
	...
	public void testClear_1()
		throws Exception {
		AccessTypeProcesssor fixture = new AccessTypeProcesssor();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(AccessTypeProcesssorTest.class);
	}
}