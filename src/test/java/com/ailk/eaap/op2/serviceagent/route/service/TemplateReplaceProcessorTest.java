...
/**
 * The class <code>TemplateReplaceProcessorTest</code> contains tests for the class <code>{@link TemplateReplaceProcessor}</code>.
 *
 * @generatedBy CodePro at 15-11-12 下午8:10
 * @author wuwz
 * @version $Revision: 1.0 $
 */
public class TemplateReplaceProcessorTest {
	/**
	...
	public void testClear_1()
		throws Exception {
		TemplateReplaceProcessor fixture = new TemplateReplaceProcessor();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(TemplateReplaceProcessorTest.class);
	}
}