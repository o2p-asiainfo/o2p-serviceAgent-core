...
public class MessageBO<T> implements Serializable,IMessageBO<T>, Cloneable{
	...
	public  static final String Default_JSON_Username = "$.Username";
	...
	private T msgBody;
	private Map<String, Object> subMsgBodyMap = new Hashtable<String, Object>();
	...
	//需要搬迁的文件信息
	private List<ExtAttr> moveFileInfos; 
	private Tenant tenant = new Tenant();
	private String serviceStyle;
	private String queueName;
	
	private Map<String, MessageBO<?>> messageBoHisMap = new HashMap<String, MessageBO<?>>();
	private Map<String, Timestamp> timeMap = new HashMap<String, Timestamp>();
	...
	public String[] getTaskCacheFlag() {
		if(!ArrayUtils.isEmpty(taskCacheFlag)){
			return (String[]) ArrayUtils.clone(taskCacheFlag);
		}
		return null;
	}
	...
	public List<ExtAttr> getMoveFileInfos() {
		return moveFileInfos;
	}

	public void setMoveFileInfos(List<ExtAttr> moveFileInfos) {
		this.moveFileInfos = moveFileInfos;
	}

	public Map<String, MessageBO<?>> getMessageBoHisMap() {
		return messageBoHisMap;
	}

	public void setMessageBoHisMap(Map<String, MessageBO<?>> messageBoHisMap) {
		this.messageBoHisMap = messageBoHisMap;
	}

	public Map<String, Timestamp> getTimeMap() {
		return timeMap;
	}

	public void setTimeMap(Map<String, Timestamp> timeMap) {
		this.timeMap = timeMap;
	}

	public Map<String, Object> getSubMsgBodyMap() {
		return subMsgBodyMap;
	}

	public void setSubMsgBodyMap(Map<String, Object> subMsgBodyMap) {
		this.subMsgBodyMap = subMsgBodyMap;
	}
}