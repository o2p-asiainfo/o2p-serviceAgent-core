...
import com.ailk.eaap.op2.serviceagent.route.jms.topic.service.ITopicConsumer;
...
public class JMSTopicProcessor implements EndpointProcessor{

	private static final Logger LOG = Logger.getLog(JMSTopicProcessor.class);
	...
	public MessageBO process(Endpoint endpoint, MessageBO msg) {
		...
		ITopicConsumer topicConsumer = TopicFactory.getTopicConsumer(mqTypeObject.toString());
		topicConsumer.getMessageFromTopic(tech,msg);
